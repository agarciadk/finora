...
- If the pre-commit hook cannot be made to pass after reasonable attempts, stop, leave the task uncommitted, and report the blocker instead of bypassing the hook.

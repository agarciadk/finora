...
// Recharts injects active/payload/label/coordinate at runtime via cloneElement,
// so this component's own prop type keeps them optional and version-agnostic
// instead of depending on Recharts' (frequently-changing) internal types.
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-2xl bg-popover px-2.5 py-1.5 text-xs text-popover-foreground shadow-lg ring-1 ring-foreground/5 dark:ring-foreground/10",
        className
      )}
    >
...
// Extracts the config entry (label/icon/color) matching a recharts payload item.
